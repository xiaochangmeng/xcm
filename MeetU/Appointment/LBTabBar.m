...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self=[super initWithFrame:frame]) {
        ...
        [plusBtn setBackgroundImage:[UIImage imageNamed:@"形状-19-拷贝-10@2x(1)"] forState:UIControlStateNormal];
        [plusBtn setBackgroundImage:[UIImage imageNamed:@"形状-19-拷贝-10@2x(1)"] forState:UIControlStateHighlighted];
...
- (void)layoutSubviews
{
    ...
    self.plusBtn.size = CGSizeMake(self.plusBtn.currentBackgroundImage.size.width, self.plusBtn.currentBackgroundImage.size.height);
        ...
        label.centerY = CGRectGetMaxY(self.plusBtn.frame) + LBMagin + 3.4;
