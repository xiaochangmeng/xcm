...
@interface CustomLoadingView()<CAAnimationDelegate>
...
{
    CustomLoadingView *loadingView = [[CustomLoadingView alloc] initWithFrame:CGRectMake(0, 0, view.width, view.height)];
...
+ (CustomLoadingView *)showLoadingWithWindow
{
    ...
    CustomLoadingView *loadingView = [[CustomLoadingView alloc] initWithFrame:CGRectMake(0, 0,[UIScreen mainScreen].bounds.size.width,[UIScreen mainScreen].bounds.size.height)];
    loadingView.userInteractionEnabled = NO;
