...
NSString *const JHRefreshHeaderStatusTextNormal = @"下拉可以刷新";
NSString *const JHRefreshHeaderStatusTextPulling = @"释放刷新";
NSString *const JHRefreshHeaderStatusTextRefreshing = @"更新中...";
NSString *const JHRefreshHeaderStatusTextSuccess = @"刷新成功";
NSString *const JHRefreshHeaderStatusTextFailure = @"刷新失败";

NSString *const JHRefreshFooterStatusTextNormal = @"上拉加载更多数据";
NSString *const JHRefreshFooterStatusTextPulling = @"松开立即加载更多数据";
NSString *const JHRefreshFooterStatusTextRefreshing = @"加载中...";
