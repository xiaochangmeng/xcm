...
-(void)viewWillAppear:(BOOL)animated{
    [super viewWillAppear:animated];
      _searchSuggestionVC.view.frame = CGRectMake(0, 64, self.view.py_width, self.view.py_height);
    [[NSNotificationCenter defaultCenter] postNotificationName:@"tableViewhigt" object:nil];
}
/** 视图完全显示 */
